...
function Inventory() {
    ...
    this.weapons = assets.saveData.slot1.inventory.weapons;
    this.armor = {};
    this.consumables = {};
    this.keyItems = {};
